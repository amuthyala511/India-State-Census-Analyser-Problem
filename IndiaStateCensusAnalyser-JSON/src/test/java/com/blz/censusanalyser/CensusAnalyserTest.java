...
public class CensusAnalyserTest {
	...
	@Test
	public void givenIndianCensusData_ShouldSortAccToArea_FromLargestToSmallest_ShouldReturnResult() {
		String sortedCensusData = null;
		try {
			sortedCensusData = censusAnalyser.getAreaWiseSortedStateCensusData(INDIA_CENSUS_CSV_FILE_PATH);
			IndiaCensusCSV[] censusCSV = new Gson().fromJson(sortedCensusData, IndiaCensusCSV[].class);
